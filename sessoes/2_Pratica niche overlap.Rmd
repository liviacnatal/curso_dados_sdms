...
pj_occ_inv_area <- subset(wrld_simpl, wrld_simpl$NAME == "Brazil")
...
pj_inv_early <- subset(pj_occ_inv, pj_occ_inv$year <= 1990)
pj_inv_late <- subset(pj_occ_inv, pj_occ_inv$year > 1990)
